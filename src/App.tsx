...
function App() {
  ...
  const repoDescriptions: { [key: string]: string } = {
    ...
    'PortfolioMZ': 'Professional portfolio website showcasing AI, RPA, and Business Transformation expertise. Built with React 18, TypeScript, and Vite. Features dynamic GitHub repository integration with custom descriptions, collapsible About sections (Bio & Technical Expertise), carousel-based Events showcase (conferences, meetups, workshops), profile photo display, responsive design, and automated deployment via GitHub Actions to GitHub Pages. Includes comprehensive documentation (deployment guides, troubleshooting, events management). Showcases UiPath MVP 2024 & 2025 recognition, speaking engagements, educational activities, and technical projects. Live at mikzielinski.github.io/PortfolioMZ.',
